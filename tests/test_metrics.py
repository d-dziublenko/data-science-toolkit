...
from evaluation.metrics import (
    ModelEvaluator, RegressionMetrics, ClassificationMetrics,
    CustomMetric, MetricCalculator
)
from evaluation.visualization import (
    ModelVisualizer, PlotConfig, PerformancePlotter
)
from evaluation.uncertainty import (
    UncertaintyQuantifier, BootstrapUncertainty,
    PredictionInterval
)
from evaluation.drift import (
    DataDriftDetector, DriftType, StatisticalDriftDetector
)
...
class TestRegressionMetrics(unittest.TestCase):
    ...
    def test_calculate_all(self):
        ...
        expected_metrics = ['rmse', 'mae', 'r2', 'mape', 'explained_variance',
...
class TestClassificationMetrics(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.y_proba_binary = np.array([
            ...
            [0.8, 0.2], [0.6, 0.4], [0.7, 0.3], [0.3, 0.7]
        ])
    ...
    def test_confusion_matrix_analysis(self):
        ...
        self.assertAlmostEqual(
            cm_analysis['tpr'] + cm_analysis['fnr'], 
            1.0, 
            places=5
        )
...
class TestDataDriftDetection(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_data_drift = pd.DataFrame({
            ...
            'category': np.random.choice(['A', 'B', 'C'], 200, p=[0.6, 0.3, 0.1])  # Distribution changed
        })
