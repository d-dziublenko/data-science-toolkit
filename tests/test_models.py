...
from models.base import AutoML, BaseModel, SimpleLinearModel
from models.ensemble import EnsembleModel, ModelBlender, ModelStacker
from models.neural import NeuralNetworkClassifier, NeuralNetworkRegressor
from models.transformers import (AutoTargetTransformer, BoxCoxTransformer,
                                 LogTransformer, TargetTransformer,
...
class TestEnsembleModels(unittest.TestCase):
    ...
    def test_ensemble_model(self):
        ...
        ensemble = EnsembleModel(
            base_models=self.base_models, voting="soft", weights=None
        )
    ...
    def test_model_stacker(self):
        ...
        stacker = ModelStacker(
            base_models=self.base_models, meta_model="linear", cv_folds=3
        )
...
class TestTargetTransformers(unittest.TestCase):
    ...
    def test_auto_target_transformer(self):
        ...
        self.assertIn(
            transformer.best_method_, ["none", "log", "sqrt", "box-cox", "yeo-johnson"]
        )
